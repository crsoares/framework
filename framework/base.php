...
namespace Framework
{
    ...
    class Base
    {
        ...
        {
            return new Exception\ReadOnly("{$property} é somente leitura");
        }
        
        protected function _getExceptionForWriteonly($property)
        {
            return new Exception\WriteOnly("{$property} é somente gravação");
        }
        
        protected function _getExceptionForProperty()
        {
            return new Exception\Property("propriedade inválido");
        }
        
        protected function _getExceptionForImplementation($method)
        {
            return new Exception\Argument("{$method} método não implementado");
        }
    }
}
